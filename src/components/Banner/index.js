        ...
        <Slider {...setting}>
          <section className='swiper-slide promo pizza'>
            <h2 className='promo-title'>
              Онлайн-сервис доставки еды<br/> на дом
            </h2>
            <p className='promo-text'>
              Блюда из любимого ресторана привезет курьер в перчатках, маске и сантисептиком
            </p>
          </section>

          <section className='swiper-slide promo kebab'>
            <h2 className='promo-title'>
              Шашлыки на майские<br/> <b>со скидкой 35%</b>
            </h2>
            <p className='promo-text'>
          ...
          <section className='swiper-slide promo sushi'>
            <h2 className='promo-title'>
              Сеты с скидкой до 20%<br/> в ресторанах
            </h2>
            <p className='promo-text'>
